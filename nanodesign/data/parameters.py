...
class DnaParameters(object):
    """ This class stores information for DNA parameters.
        ...
        Attributes:
            helix_distance: The distance between the axes of two neighboring
                DNA helices.
            helix_radius: The radius of DNA helices (nm).
            base_pair_rise: The rise between two neighboring base-pairs (nm).
            base_pair_twist_angle: The twisting angle between two neighboring
                base-pairs (degree).
...
class DnaPolarity:
    """ This class defines constants used to describe the polarity of a DNA
        strand.

        Attributes:
            FIVE_PRIME (string): The direction of a DNA strand is from 5'->3'.
                When indexing the bases in a helix this means
                indexes increase in the 5'->3' direction.
            THREE_PRIME (string): The direction of a DNA strand is from 3'->5'.
                When indexing the bases in a helix this means
