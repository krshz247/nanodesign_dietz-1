...
""" This module contains classes used to define the lattice-base geometric
    framework of a DNA structure.
...
class Lattice(object):
    ...
    def get_neighbors(cls, row, col):
        """ Get the neighboring lattice coordinates for a given lattice
            coordinate.
        """
    ...
    def create_lattice(lattice_type, helix_distance):
        """ Create a lattice object for a given type.
            ...
            Arguments:
                lattice_type (Int): The lattice type (e.g. honeycomb) taken
                    from CadnanoLatticeType.
                helix_distance (Float): The distance between adjacent DNA
                    helices.
        """
...
class SquareLattice(Lattice):
    """ This class defines the data and methods for a square lattice.
        Attributes:
            index (List[Tuple()]): The list used to map lattice (row,col)
                coordinates to a neighbor index (0-3).
            number_of_neighbors (int): The number of lattice cell neighbors.
            scaffold_low (List[List[Int]]): The list scaffold of crossover
                points.
            scaffold_high (List[List[Int]]): The list scaffold of crossover
                points.
        ...
        Some of the data in this class is used to compute crossover positions
        between neighboring helices on a square lattice. It is based on the
        data from the caDNAno squarepart.py file.

        The index_map list is used to map a lattice (row,col) coordinate to a
        neighbor (nrow,ncol) index. The index identifies the neighbor direction
        in a standard way.
    ...
    def get_neighbors(cls, row, col):
        ...
        coordinate.
            ...
            Returns:
                neighbors (list[(int,int)): The list of neighboring lattice
                    coordinates.
        """
        neighbors = []
    ...
    def get_neighbor_index(cls, row, col, nrow, ncol):
        """ Get the index for a neighboring lattice coordinate.
            ...
            Returns:
                nindex (Int): The neighbor index or None if the lattice
                    coordinates are not a neighbor.
        """
...
class HoneycombLattice(Lattice):
    """ This class defines the data and methods for a honeycomb lattice.
        Attributes:
            index_map_odd (List[Tuple()]): The list used to map lattice
                (row,col) coordinates into a neighbor index (0-2) for
                odd-numbered helices.
            index_map_even (List[Tuple()]): The list used to map lattice
                (row,col) coordinates into a neighbor index (0-2) for
                even-numbered helices.
            number_of_neighbors (int): The number of lattice cell neighbors.
            scaffold_low (List[List[Int]]): The list scaffold of crossover
                points.
            scaffold_high (List[List[Int]]): The list scaffold of crossover
        ...
        Some of the data in this class is used to compute crossover positions
        between neighboring helices on a honeycomb lattice. It is based on the
        data from the caDNAno honeycombpart.py file.
