...
""" This module is used to store data for a DNA base.
    ...
    A list of DnaBase objects, stored in the DnaStructure object, is used to
    define the connectivity (topology) of a DNA structure: bases that are
    adjacent along a single DNA helix and which base they are paired with
    (if any).
"""
...
class DnaBase(object):
    """ This class stores information for a DNA base.
        ...
        Attributes:
            ...
            coordinates ((3x1 numpy float arrayList[Float]): The base helix
                axis coordinates.
            ...
            nt_coords ((3x1 numpy float arrayList[Float]): The base nucleotide
                coordinates.
            ref_frame ((3x1 numpy float arrayList[Float]): The base helix axis
                reference frame.
            p (int): The helix position of the base.
            seq (string): A one character string representing the base sequence
                nucleotide.
        ...
        The base coordinates and reference frame are references to elements of
        arrays stored in the helix they are associated with.
    """
    ...
    def remove(self):
        """ Remove the base from the DNA structure.
            ...
            This function is used to remove bases flagged for deletion in the
            design file and is called when the design file is being processed.
            It will reset neighboring bases connectivity including the paired
